...
$(".prof_icon").on('click', function () {
    ...
    if ($(".prof_info").is(":visible")) {
        ...
        $(".prof_info").hide();   // открытие/скрывание главного окна профиля с содержимым
...
function showItem(thisCLASS, CLASS) {  // параметры: (скрываемое окно, показываемое окно)
    $('.' + thisCLASS).hide();   // скрыть "скрываемое окно"
    $(".prof-main-punkt").hide();
    $('.' + CLASS).show();   // показать "показываемое окно"
